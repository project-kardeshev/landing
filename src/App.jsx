  ...
  return (
    <>
      <header>
        <nav className="bg-white border-gray-200 dark:bg-gray-800 px-4 py-2.5 lg:px-6">
          <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between">
            ...
            <div className="flex items-center lg:order-2">
              <a
                href="https://app_project-kardeshev.ar-io.dev/#/"
            ...
            >
              <ul className="mt-4 flex flex-col font-medium lg:mt-0 lg:flex-row lg:space-x-8">
                <li>
                  <a
                    href="https://app_project-kardeshev.ar-io.dev/#/about"
        ...
        <iframe src="https://audio-renderer_project-kardeshev.ar-io.dev/?tx=ichh54jepRRGgLOB0NR-CpE5-ey35BHLE2B69Lk4cUc"
